...
public class DirectoryToText {
	...
	public static final String[] textFileExtesions = new String[] {
			".txt", ".java", ".md", ".log", ".xml", ".json", ".csv", ".html", ".css", ".js", ".properties", ".py"
	};
	...
	private static String getFormattingRules() {
		...
		rules.append("  - Non-text files do not have content lines, only name and the end marker \";\".\n");
		rules.append("------------------------------------------\n\n");
	...
	public static boolean isTextFile(java.io.File file) {
		...
		for(String extension : textFileExtesions) {
	...
	public static void main(String[] args) {
		if(args.length != 0) {
			File selectedDirectory = new File(args[0]);
