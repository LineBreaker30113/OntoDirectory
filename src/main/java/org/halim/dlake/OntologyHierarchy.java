...
import org.halim.hport.OntoDirectoryException.NullGivenAsOntologyClassException;
...
public final OntologyHierarchyReader reader = new OntologyHierarchyReader();
...
// ==============================================================================
// INNER CLASSES IMPLEMENTING HEXAGONAL PORTS
// ==============================================================================
...
public class OntologyHierarchyReader implements OntologyReadingService {
	...
	@Override
	public OntologyClass getRootOntologyClass() {
		return ontologyClasses.getFirst();
	}
		...
		if (parentNames != null) {
			for (String pName : parentNames) {
				...
				if (parent != null) {
					...
					throw new NullGivenAsOntologyClassException(
